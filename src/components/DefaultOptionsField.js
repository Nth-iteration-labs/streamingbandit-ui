...
class DefaultOptionsField extends React.Component {
  ...
  handleChange(event, index, value) {
    ...
    fetch(store.serverurl + "/exp/defaults/" + index, {
      method: "GET",
      ...
      .then(({ status, statusText, headers, body, ok }) => {
        if (!ok) {
          let cm = document
            .getElementsByClassName("aor-input-get_context")[0]
          ...
          cm = document
            .getElementsByClassName("aor-input-get_action")[0]
            .getElementsByClassName("CodeMirror")[0];
          editor = cm.CodeMirror;
          editor.setValue("");
          cm = document
            .getElementsByClassName("aor-input-get_reward")[0]
            .getElementsByClassName("CodeMirror")[0];
          editor = cm.CodeMirror;
          editor.setValue("");
          cm = document
            .getElementsByClassName("aor-input-set_reward")[0]
            .getElementsByClassName("CodeMirror")[0];
          editor = cm.CodeMirror;
          editor.setValue("");
        ...
        try {
          ...
          let cm = document
            ...
            .getElementsByClassName("CodeMirror")[0];
          let editor = cm.CodeMirror;
          if (json.hasOwnProperty("get_context")) html = json.get_context;
          else html = "# not defined \n";
          editor.setValue(html);
          cm = document
            .getElementsByClassName("aor-input-get_action")[0]
            .getElementsByClassName("CodeMirror")[0];
          editor = cm.CodeMirror;
          if (json.hasOwnProperty("get_action")) html = json.get_action;
          else html = "# not defined \n";
          editor.setValue(html);
          cm = document
            .getElementsByClassName("aor-input-get_reward")[0]
            .getElementsByClassName("CodeMirror")[0];
          editor = cm.CodeMirror;
          if (json.hasOwnProperty("get_reward")) html = json.get_reward;
          else html = "# not defined \n";
          editor.setValue(html);
          cm = document
            .getElementsByClassName("aor-input-set_reward")[0]
            .getElementsByClassName("CodeMirror")[0];
          editor = cm.CodeMirror;
          if (json.hasOwnProperty("set_reward")) html = json.set_reward;
          else html = "# not defined \n";
          editor.setValue(html);
  ...
  componentWillMount() {
    fetch(store.serverurl + "/exp/defaults", {
      method: "GET",
      headers: new Headers({ "Content-Type": "application/json" }),
      credentials: "include"
    })
